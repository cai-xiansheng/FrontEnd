...
// 5. 既然 Promise 创建的实例，是一个异步操作，那么这个异步操作的结果，只能由两种状态：
...
// 注意：这里 new 出来的 Promise ,只是代表形式上的一个异步操作；
// 什么是形式上的异步操作：就是说我们知到它是一个异步操作，但是做什么具体的异步事情，目前还不清楚

// var promise = new Promise()


// 这是一个异步操作，其中，使用 function 指定的一个具体的异步操作
// var promise = new Promise(function(){
  // 这个 function 内部写的就是具体的一部操作！！！
// })


const fs = require('fs')

// 每当 new 一个 Promise 实例的时候，就会立即执行这个异步操作的代码
// 也就是说，new 的时候，处理能够得到一个 promise 实例之外，还会立即调用，我们为 Promise 构造函数传递的那个 function，执行这个 function 中的异步操作代码；
// var promise = new Promise(function() {
